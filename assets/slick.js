(function (a) {
    ...
    b = (function () {
        ...
        function d(g, h) {
            ...
            if (e.options.centerMode == true || e.options.vertical == true) {
                e.options.slidesPadding = e.options.slidesMargin;
            }
            if (e.options.fade == true || e.options.vertical == true || e.options.centerMode == true) {
                e.options.slidesMargin = 0;
            }
    ...
    b.prototype.animateSlide = function (f, e) {
        ...
        if (c.transformsEnabled === false) {
            ...
            if (c.cssTransitions === false) {
                ...
                a({ animStart: c.currentLeft }).animate(
                    { animStart: f },
                    {
    ...
    b.prototype.buildOut = function () {
        ...
        if (c.options.centerMode == true) {
            c.$slider.addClass("slick-center-mode");
        }
        c.$slideTrack =
            c.slideCount === 0
    ...
    b.prototype.buildRows = function () {
        ...
        if (d.options.rows > 1) {
            ...
            d.$slider
                ...
                .children()
                .children()
                .css({ width: 100 / d.options.slidesPerRow + "%", display: "inline-block" });
        }
    };
    ...
    b.prototype.cleanUpEvents = function () {
        ...
        if (c.options.dots && c.$dots !== null) {
            a("li", c.$dots)
                ...
                .off("mouseenter.slick", a.proxy(c.interrupt, c, true))
                .off("mouseleave.slick", a.proxy(c.interrupt, c, false));
    ...
    b.prototype.destroy = function (d) {
        ...
        c.$slider.removeClass("slick-center-mode");
    ...
    b.prototype.fadeSlide = function (e, d) {
        var c = this;
        if (c.cssTransitions === false) {
            c.$slides.eq(e).css({ zIndex: c.options.zIndex });
            c.$slides.eq(e).animate({ opacity: 1 }, c.options.speed, c.options.easing, d);
        } else {
            c.applyTransition(e);
            c.$slides.eq(e).css({ opacity: 1, zIndex: c.options.zIndex });
            if (d) {
                setTimeout(function () {
        ...
        if (c.options.infinite === true) {
            if (c.slideCount <= c.options.slidesToShow) {
                ...
                while (d < c.slideCount) {
                    ...
                    e +=
                        c.options.slidesToScroll <= c.options.slidesToShow
    ...
    b.prototype.getLeft = function (e) {
        var c = this,
            ...
            g,
            d;
        c.slideOffset = -(e * (c.options.slidesMargin / c.options.slidesToShow));
        h = c.$slides.first().outerHeight(true);
        if (c.options.infinite === true) {
            if (c.slideCount > c.options.slidesToShow) {
                c.slideOffset =
                    (c.slideWidth * c.options.slidesToShow +
                        c.options.slidesMargin +
                        e * Math.floor(c.options.slidesMargin / c.options.slidesToShow)) *
                    -1;
                d = -1;
            ...
            if (c.slideCount % c.options.slidesToScroll !== 0) {
                if (e + c.options.slidesToScroll > c.slideCount && c.slideCount > c.options.slidesToShow) {
                    if (e > c.slideCount) {
                        ...
                        c.slideOffset =
                            ((c.slideCount % c.options.slidesToScroll) * c.slideWidth +
                                c.slideWidth / 2 +
                                c.options.slidesMargin / 2) *
                            -1;
            ...
            if (e + c.options.slidesToShow > c.slideCount && c.options.slidesToScroll === 1) {
                c.slideOffset =
                    (e + c.options.slidesToShow - c.slideCount) * c.slideWidth -
                    c.options.slidesMargin / c.options.slidesToShow;
        ...
        if (c.options.centerMode === true && c.slideCount <= c.options.slidesToShow) {
            c.slideOffset = (c.slideWidth * Math.floor(c.options.slidesToShow)) / 2 - (c.slideWidth * c.slideCount) / 2;
        } else {
    ...
    b.prototype.goTo = b.prototype.slickGoTo = function (e, d) {
        var c = this;
        c.changeSlide({ data: { message: "index", index: parseInt(e) } }, d);
    };
    ...
    b.prototype.initADA = function () {
        ...
        c.$slides
            .add(c.$slideTrack.find(".slick-cloned"))
            .attr({ "aria-hidden": "true", tabindex: "-1" })
            .find("a, input, button, select")
            .attr({ tabindex: "-1" });
        if (c.$dots !== null) {
            c.$slides.not(c.$slideTrack.find(".slick-cloned")).each(function (h) {
                var j = g.indexOf(h);
                a(this).attr({ role: "tabpanel", id: "slick-slide" + c.instanceUid + h, tabindex: -1 });
                if (j !== -1) {
                    a(this).attr({ "aria-describedby": "slick-slide-control" + c.instanceUid + j });
                }
            });
            c.$dots
                .attr("role", "tablist")
    ...
    b.prototype.initDotEvents = function () {
        ...
        if (c.options.dots === true && c.options.pauseOnDotsHover === true) {
            a("li", c.$dots)
                .on("mouseenter.slick", a.proxy(c.interrupt, c, true))
                .on("mouseleave.slick", a.proxy(c.interrupt, c, false));
        }
    };
            ...
            a("img[data-lazy]", i).each(function () {
                ...
                r.onload = function () {
                    n.animate({ opacity: 0 }, 100, function () {
                        ...
                        n.attr("src", p).animate({ opacity: 1 }, 200, function () {
    ...
    b.prototype.setCSS = function (d) {
        var c = this,
            ...
            f,
            g;
        if (c.options.rtl === true && c.options.vertical !== true) {
            d = -d;
        }
    ...
    b.prototype.setDimensions = function () {
        var c = this,
            d = 0,
            e = c.options.slidesMargin * c.$slideTrack.children(".slick-slide").length;
        if (c.options.vertical === false) {
            if (c.options.centerMode === true) {
        ...
        if (c.options.vertical === false && c.options.variableWidth === false) {
            d = c.options.slidesMargin / c.options.slidesToShow;
            c.slideWidth = Math.abs(c.listWidth / c.options.slidesToShow);
            c.$slideTrack.width(Math.abs(c.slideWidth * c.$slideTrack.children(".slick-slide").length) + e);
        } else {
            if (c.options.variableWidth === true) {
                c.$slideTrack.width(5000 * c.slideCount);
            } else {
                c.slideWidth = Math.abs(c.listWidth);
                c.$slideTrack.height(
                    Math.abs(c.$slides.first().outerHeight(true) * c.$slideTrack.children(".slick-slide").length)
                );
            }
        }
        var f = c.$slides.first().outerWidth(true) - c.$slides.first().width();
        if (c.options.variableWidth === false) {
            c.$slideTrack.children(".slick-slide").width(c.slideWidth - f + d);
        }
    };
    b.prototype.setFade = function () {
        ...
        c.$slides.each(function (f, e) {
            d = c.slideWidth * f * -1;
            if (c.options.rtl === true) {
                a(e).css({ position: "relative", right: d, top: 0, zIndex: c.options.zIndex - 2, opacity: 0 });
            } else {
    ...
    b.prototype.setSlideClasses = function (g) {
        ...
        if (c.options.vertical == false) {
            if (c.options.centerMode == false) {
                c.$slider
                    .children()
                    .children(".slick-track")
                    .children()
                    .css("margin-" + i, c.options.slidesMargin + "px");
            } else {
                c.$slider
                    .children()
                    .children(".slick-track")
                    .children()
                    .css("padding", "0 " + c.options.slidesPadding / 2 + "px");
            }
        } else {
            c.$slider
                .children(".slick-list")
                .css({ "margin-top": -c.options.slidesPadding / 2, "margin-bottom": -c.options.slidesPadding / 2 });
            c.$slider
                .children()
                .children(".slick-track")
                .children()
                .css({ "padding-top": c.options.slidesPadding / 2, "padding-bottom": c.options.slidesPadding / 2 });
        }
        d = c.$slider
            .children()
            .children(".slick-track")
        ...
        if (c.options.centerMode === true) {
            ...
            if (g >= 0 && g <= c.slideCount - c.options.slidesToShow) {
                c.$slides
                    .slice(g, g + c.options.slidesToShow)
                    .addClass("slick-active")
                    .attr("aria-hidden", "false");
            } else {
                if (d.length <= c.options.slidesToShow) {
                    ...
                    j = c.slideCount % c.options.slidesToShow;
                    h = c.options.infinite === true ? c.options.slidesToShow + g : g;
                    if (
                        c.options.slidesToShow == c.options.slidesToScroll &&
                        c.slideCount - g < c.options.slidesToShow
                    ) {
                        d.slice(h - (c.options.slidesToShow - j), h + j)
                            .addClass("slick-active")
                            .attr("aria-hidden", "false");
                    } else {
                        d.slice(h, h + c.options.slidesToShow)
                            .addClass("slick-active")
                            .attr("aria-hidden", "false");
                    }
                }
        ...
        c.$slider.find(".slick-active:first").addClass("first-slick").siblings().removeClass("first-slick");
        c.$slider.find(".slick-active:last").addClass("last-slick").siblings().removeClass("last-slick");
    };
            ...
            if (c.slideCount > c.options.slidesToShow) {
                ...
                for (d = c.slideCount; d > c.slideCount - e; d -= 1) {
                    ...
                    a(c.$slides[f])
                        .clone(true)
                        .attr("id", "")
                        .attr("data-slick-index", f - c.slideCount)
    ...
    b.prototype.slideHandler = function (f, j, e) {
        ...
        if (
            c.options.infinite === false &&
            c.options.centerMode === false &&
            (f < 0 || f > c.getDotCount() * c.options.slidesToScroll)
        ) {
            if (c.options.fade === false) {
                l = c.currentSlide;
                if (e !== true) {
            ...
            if (
                c.options.infinite === false &&
                c.options.centerMode === true &&
                (f < 0 || f > c.slideCount - c.options.slidesToScroll)
            ) {
                if (c.options.fade === false) {
                    l = c.currentSlide;
                    if (e !== true) {
    ...
    b.prototype.swipeHandler = function (d) {
        ...
        c.touchObject.fingerCount =
            d.originalEvent && d.originalEvent.touches !== undefined ? d.originalEvent.touches.length : 1;
